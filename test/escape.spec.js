...
const { _escapeArg, escapeArg, escapeUnixShellArg, escapeWinCmdArg } = jest.requireActual(
  '../lib/escape'
)
...
describe('escapeArg', () => {
  it('should use current platform by default', () => {
    ...
    expect(escapeArg(TEST_STRING)).toEqual(isWin ? WINCMD_ESCAPED : UNIX_ESCAPED)
  })
  ...
  test.each([
    ...
    expect(_escapeArg(TEST_STRING, platform)).toEqual(escaped)
  })
})
